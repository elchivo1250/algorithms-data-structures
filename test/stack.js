...
ava('Stack constructor', (t) => {
    ...
    t.deepEqual(s.collection, [], 'The default collection is incorrect');
});
...
ava('Stack constructor with good param (array)', (t) => {
    ...
    t.deepEqual(s.collection, data, 'The collection is incorrect');
});
...
ava('Stack constructor with good param (null)', (t) => {
    ...
    t.deepEqual(s.collection, [], 'The collection is incorrect');
});
...
ava('Stack push', (t) => {
    ...
    t.deepEqual(s.collection, data, 'The stack size is incorrect');
});
...
ava('Stack pop', (t) => {
    ...
    t.deepEqual(s.collection, [data[0], data[1]], 'The stack state is incorrect');
});
